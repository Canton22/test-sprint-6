...
if hist_button: #Presionar este boton.
    ...
    fig = px.histogram(car_data, x = "type") #Mostrar una grafica de histograma con los diferentes tipos de vehiculos.
...
if dispersion_button: #Presionar este boton.
    ...
    fig = px.scatter (car_data, x = "type", y = "price") #Mostrar una grafica de dispercion de los tipos y costos de vehiculos.
